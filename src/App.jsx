...
const questions = [
  ...
  },
  {
    ...
    options: [
      ...
      {
        text: "Não sei, nunca tentei controlar o dinheiro com planilha, mas tenho curiosidade",
        score: 2,
        emoji: "🤔",
      },
    ],
...
const offer = {
  ...
  oldPrice: "R$127,00", // ✅ ALTERADO (era R$97,00)
  newPrice: "R$27,00",  // ✅ ALTERADO (era R$19,90)
